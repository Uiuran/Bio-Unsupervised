...
Original file is located at
    https://colab.research.google.com/drive/19ZRA2yYFpAIIM9QY_i6wG2XiHhCYPK2y
"""

import numpy as np

def mutual_information(X,Y,k=10,base=np.exp(1)):
  """ Estimation of Mutual Information based on KNN instead of binned histograms, based on [1].
    Bizarre digamma functions just appears as you do not use fixed bins nor explicity estimate probability functions,
    just follow the paper if you were to discover.


  Inputs function:
  X,Y         : an N x M matrix (samples x features or unravelled tensors)
  k           : the number of nearest neighbour
  unit base   : base=2 -> Shannon (bits), base=exp(1)=nat
  
  TODO: Scale-wise mutual information calculation for images
